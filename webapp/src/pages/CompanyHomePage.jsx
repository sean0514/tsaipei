...
export default function CompanyHomePage() {
  ...
  const profiles = { tsaipei: tsaipeiProfile, foodfactory: foodfactoryProfile, dispatch: dispatchProfile, dormMgmt: dormMgmtProfile };
  const overrides = { tsaipei: tsaipeiOverrides, foodfactory: foodfactoryOverrides, dispatch: dispatchOverrides, dormMgmt: dormMgmtOverrides };
